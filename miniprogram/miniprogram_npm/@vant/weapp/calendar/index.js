    ...
    methods: {
        ...
        initRect: function () {
            ...
            contentObserver.observe('.month', function (res) {
                if (res.boundingClientRect.top <= res.relativeRect.top) {
                    // @ts-ignore
                    _this.setData({
                        subtitle: (0, utils_1.formatMonthTitle)(
                            res.dataset.date,
                        ),
                    });
                }
        ...
        onClickDay: function (event) {
            ...
            if (type === 'range') {
                ...
                if (startDay_1 && !endDay) {
                    var compareToStart = (0, utils_1.compareDay)(
                        date,
                        startDay_1,
                    );
                    if (compareToStart === 1) {
                ...
                if (selected) {
                    ...
                    this.select(
                        __spreadArray(
                            __spreadArray([], currentDate, true),
                            [date],
                            false,
                        ),
                    );
            ...
            if (complete && this.data.type === 'range') {
                ...
                if (!valid) {
                    ...
                    if (this.data.showConfirm) {
                        this.emit([
                            date[0],
                            (0, utils_1.getDayByOffset)(
                                date[0],
                                this.data.maxRange - 1,
                            ),
                        ]);
                    } else {
                        this.emit(date);
        ...
        onConfirm: function () {
            ...
            wx.nextTick(function () {
                ...
                _this.$emit(
                    'confirm',
                    (0, utils_1.copyDates)(_this.data.currentDate),
                );
            });
        },
